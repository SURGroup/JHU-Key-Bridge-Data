...
The output of the prefiltered script, if ran, will be saved to the PreFiltered_Ship_Data folder. It is left empty, since GitHub cannot store that much data.
